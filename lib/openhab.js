//TODO consider HA item discovery via 'config.HA_server + '/rest/items'
...
function getState(itemName, callback) {
    request(config.HA_server + "/rest/items/" + itemName + "/state", function (err, response) {
        if (err) {
...
/***************** VOICE COMMANDS **********************/
// Execute voice command, wait for server side flag, and return the HA response/answer
